  ...
  return (
    <div className="product-card-1">
      ...
      <div className="product-details-1">
        ...
        {/* Kiểm tra nếu product.id không phải là 11, 12, 13, 14 thì mới hiển thị giá gốc */}
        {product.id !== '11' && product.id !== '12' && product.id !== '13' && product.id !== '14' && product.id !== '15' && (
      ...
      const fetchProducts = async () => {
        try {
          const response = await axios.get('http://localhost:5000/api/products', {
            params: { ids: '10,11,12,13,14,15' } // Thay đổi danh sách ID theo nhu cầu
          });
